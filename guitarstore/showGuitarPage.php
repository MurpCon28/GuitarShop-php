...
try {
    ...
    if ($imageGuitarFile != null) {
        if ($guitar->image != null && $guitar->image != 'uploads/guitar_default.png' && file_exists($guitar->image)) {
            unlink($guitar->image);
        }
    ...
    header("Location: viewGuitarPage.php");
}
catch (Exception $ex) {
    require 'viewGuitarPage.php';
}
?>
